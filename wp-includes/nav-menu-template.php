...
// 	$items = apply_filters( 'wp_nav_menu_items', $items, $args );
	...
	$nav_menu = str_replace("</ul>","",$nav_menu);

	$nav_menu .= '<li class = "menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-104 current_page_item menu-item-301" style="padding-left: 20px">';
	$nav_menu .= 'Hello Ashanti <br />'; 
	$nav_menu .= '257 <span class="dashicons dashicons-marker"></span>';
	$nav_menu .= '</li>';
	$nav_menu .= '</ul>';
